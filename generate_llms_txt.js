...
let llmsTxt = `# 背徳の館 (er-2) - アダルト＆同人コミックレビューポータルサイト

> 背徳の館 er-2（https://er-2.pages.dev）は、最新のアダルト動画・同人マンガ・FANZA人気作品の完全オリジナルレビューおよび徹底解析コンテンツを提供する情報ポータルサイトです。
...
let llmsFullTxt = `# 背徳の館 (er-2) 完全ナレッジベース & コンテンツ全集
...
console.log('er-2 llms.txt, llms-full.txt, robots.txt generated');
