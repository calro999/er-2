...
export default function PostListContainer({ initialPosts }: PostListContainerProps) {
  ...
  const hasActiveFilters = searchQuery || selectedGenre !== "すべて" || selectedActress !== "すべて" || selectedLabel !== "統括";
                    ...
                    <div className="pt-3.5 flex flex-col gap-3 border-t border-slate-100">
                      ...
                      <div className="flex gap-2">
                        ...
                        <a
                          ...
                          className="flex-1 text-center text-xs font-bold text-white bg-gradient-to-r from-rose-500 to-rose-600 hover:from-rose-400 hover:to-rose-500 py-2.5 rounded-xl shadow transition duration-200 cursor-pointer"
                        >
                          作品を視聴する
                        </a>
                      </div>
