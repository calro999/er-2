...
export const metadata: Metadata = {
  title: "禁断のバクロファイル【素人・流出AV 人気ランキング 2026】",
  description: "FANZAで今話題の素人・流出・ナンパ系AV作品を厳選したランキング。2026年最新の人気女優・ジャンル別おすすめ作品を徹底レビュー。品番検索・感想・評価も掲載。",
  keywords: ["FANZA ランキング 2026","素人 AV 人気ランキング","流出 動画 おすすめ","ナンパ AV 人気","AV おすすめ","AV ランキング","アダルトビデオ 人気"].join(","),
  alternates: { canonical: "https://er-2.pages.dev/ranking" },
  openGraph: {
    title: "禁断のバクロファイル【素人・流出AV 人気ランキング 2026】",
    description: "FANZAで今話題の素人・流出・ナンパ系AV作品を厳選したランキング。2026年最新の人気女優・ジャンル別おすすめ作品を徹底レビュー。品番検索・感想・評価も掲載。",
    url: "https://er-2.pages.dev/ranking",
    type: "website",
  },
  twitter: {
...
export default function RankingPage() {
  ...
  const breadcrumbSchema = {
    ...
    "itemListElement": [
      { "@type": "ListItem", "position": 1, "name": "ホーム", "item": "https://er-2.pages.dev" },
      { "@type": "ListItem", "position": 2, "name": "人気ランキング", "item": "https://er-2.pages.dev/ranking" }
    ]
  };
  const faqSchema = {
  ...
  const itemListSchema = {
    ...
    "name": "禁断のバクロファイル 人気AV作品ランキング2026",
    "numberOfItems": rankedPosts.length,
    "itemListElement": rankedPosts.map((post, idx) => ({ "@type": "ListItem", "position": idx + 1, "url": `https://er-2.pages.dev/posts/${post.id}`, "name": post.title }))
  };
      ...
      <div className="space-y-10 max-w-5xl mx-auto">
        ...
        <section className="rounded-2xl bg-gradient-to-br from-slate-800 to-slate-950 p-8 md:p-12 border border-slate-700/30 shadow-sm">
          <div className="space-y-4">
            ...
            <p className="text-slate-400 text-sm leading-relaxed max-w-lg">FANZAで今話題の素人・流出・ナンパ系AV作品を厳選したランキング。</p>
