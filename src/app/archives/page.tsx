...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://er-2.pages.dev/archives" },
  openGraph: {
    title: "全記事・女優・ジャンル一覧（サイトマップ）",
    description: "当サイトで紹介している全AV作品レビュー、女優一覧、ジャンル一覧を網羅したサイトマップページです。",
    url: "https://er-2.pages.dev/archives",
    type: "website",
  },
};
...
export default function ArchivesPage() {
  ...
  const breadcrumbSchema = {
    ...
    "itemListElement": [
      ...
      { "@type": "ListItem", "position": 2, "name": "サイトマップ", "item": "https://er-2.pages.dev/archives" }
    ]
  };
