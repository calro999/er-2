...
export const metadata: Metadata = {
  metadataBase: new URL("https://er-2.pages.dev"),
  title: {
    template: "%s | バクロファイル",
    default: "禁断のバクロファイル - 素人・流出・ハプニング濃厚レビュー",
  },
  description: "決して覗いてはならない、素人たちの裏の顔。裏アカ、流出、ハプニング映像を徹底レビュー。あなたの本能を直撃するリアルな快感記録。マニアが厳選したお宝映像アーカイブ。",
  keywords: [
    "素人 AV", "流出 動画", "ナンパ AV", "裏アカ 流出", "ハプニング 映像",
    "マジックミラー AV", "パパ活 AV", "素人 レビュー", "流出 レビュー",
    "FANZA 素人", "AV 感想", "AV レビュー", "品番 検索",
      ...
      <body className="min-h-full flex flex-col bg-[#f1f5f9] text-slate-900 selection:bg-rose-500 selection:text-white font-sans antialiased">
        ...
        <div className="flex-grow w-full relative flex justify-center items-start">
          ...
          <aside className="hidden xl:flex flex-col fixed left-4 top-24 w-[270px] z-30 space-y-6 items-center">
            <AmateurBanner affiliateId="onchan555-007" bannerId="1082_300_250" />
            <AmateurBanner affiliateId="onchan555-007" bannerId="377_300_250" />
            <AmateurBanner affiliateId="onchan555-007" bannerId="1980_300_250" />
          </aside>
          ...
          <aside className="hidden xl:flex flex-col fixed right-4 xl:right-[calc((100vw-1152px)/4-135px)] top-24 w-[270px] z-30 space-y-6 items-center">
            <AmateurBanner affiliateId="onchan555-007" bannerId="75_300_250" />
            <AmateurBanner affiliateId="onchan555-007" bannerId="68_300_250" />
            <AmateurBanner affiliateId="onchan555-007" bannerId="1506_300_250" />
          </aside>
        </div>
        ...
        <script async src="https://adm.shinobi.jp/st/auto.js" data-admax-id="c1ed7d2abcd8d43eef6b6e0ef324a886" suppressHydrationWarning />
      </body>
    </html>
  );
}
