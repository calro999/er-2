...
KEY = "b9g7e3c4d8f5a2b1c6d9e0f2a4b7c8d5"
HOST = "er-2.pages.dev"
...
print(f"[er-2] Total target URLs collected: {len(URL_LIST)}")
...
print("\n--- Sending IndexNow Push Signals for er-2 ---")
...
print("\n[er-2] All indexing signals dispatched successfully!")
